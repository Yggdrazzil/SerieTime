...
const styles = StyleSheet.create({
  ...
  sheetTitle: { fontSize: 20, fontFamily: FONTS.extraBold, marginBottom: 12 },
  chip: { backgroundColor: COLORS.chipGrey, borderRadius: 999, paddingHorizontal: 18, paddingVertical: 11 },
  chipOn: { backgroundColor: COLORS.yellow },
  chipText: { fontSize: 15, fontFamily: FONTS.semiBold, color: '#333' },
  chipTextOn: { color: COLORS.black },
  radioRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingVertical: 15, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: COLORS.borderLight },
  radioLabel: { fontSize: 17, fontFamily: FONTS.regular },
  ...
  resetBtn: { flex: 1, borderWidth: 1.5, borderColor: COLORS.border, borderRadius: 999, paddingVertical: 15, alignItems: 'center' },
  resetText: { fontSize: 14, fontFamily: FONTS.extraBold, letterSpacing: 0.5, color: '#666' },
  applyBtn: { flex: 1, backgroundColor: COLORS.yellow, borderRadius: 999, paddingVertical: 15, alignItems: 'center' },
