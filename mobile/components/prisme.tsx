...
export function TabHeader({ title, leading, trailing }: { title: string; leading?: React.ReactNode; trailing?: React.ReactNode }) {
  return (
    <View style={styles.tabHeader}>
      {leading ? <View style={styles.tabHeaderLeading}>{leading}</View> : null}
